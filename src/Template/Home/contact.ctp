				 	  ...
				 	  <p class="mg-semi" style="color: #2a2a2a;">
							...
							07-68-20-91-59 <br>
				 	  		...
				 	  		<a href="https://www.facebook.com/tabernacle.ga" class="hvr-bob" target="_blank">
							  	 <i class="ion-social-facebook mg-size-34 mg-margin-right-25 mg_prim_color"></i>
							  </a>
							
							<a href="#!" class="hvr-bob" target="_blank" >
								<i class="ion-ios-email mg-size-34 mg-margin-right-25 mg_prim_color"></i>
							</a>
		 					 
		 					 <a href="#!" class="hvr-bob" target="_blank">
		 					 	<i class="ion-social-whatsapp mg-size-34 mg-margin-right-25 mg_prim_color"></i>
		 					 </a>
		 	  	</div>
		 	  </div>
		 </div>
