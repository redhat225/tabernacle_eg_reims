	...
	<div ng-show="homectrl.display_poster" class="row center mg-margin-bottom-0 grey lighten-4 mg-padding-top-40 mg-padding-bottom-40">
		<div class="container">
			<div class="col l6 m6 s12">
				...
				<h5 class="uppercase mg_prim_color mg-semi mg-padding-top-10 left-align" ng-if="!homectrl.poster.event_end_date">{{homectrl.poster.event_begin_date | date:'dd'}} {{homectrl.poster.ref_month_full}} {{homectrl.poster.event_begin_date | date:'yyyy'}} à {{homectrl.poster.event_begin_date | date:'H:mm':'+0000'}}</h5>
