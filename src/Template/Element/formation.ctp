     ...
     <div class="container">
		...
		<div class="row center event-area">
				      ...
				      <div class="card-stacked">
				        <div class="card-content mg_prim_color">
				         ...
				         <div class="card-action" style="border-top:1px solid #e7cf65;">
			               <a  class="mg_prim_color mg-semi pointer tooltipped btn mg-button-1" data-tooltip="Souscrire à cette formation" data-position="top">Souscrire</a>
				        </div>
				      </div>
		     ...
		     <div class="col l6 m12 s12">
				<div class="card horizontal">
				    <div class="card-image">
				        <?= $this->Html->image('home/card_plain_element.png.png',['class'=>'activator']) ?>
				    </div>
				      <div class="card-stacked">
				        <div class="card-content mg_prim_color">
				          <h6 class="mg-bold left-align uppercase">3 Jours de transformation</h6>
